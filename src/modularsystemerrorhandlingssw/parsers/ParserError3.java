...
/**
 * Класс ParserError3 Обрабатывает тип ошибки №3 (пакеты с несовпадающими
 * данными после програмного "И").
 *
 * @author Заразка А.В. /КС-МИСАТ
 */
public class ParserError3 implements IParser {
...
//*********************************************************************************************************************************************************            
            if (tok[0].equals("3")) {
                ...
                if (strObjectID.equalsIgnoreCase(strObjectIDAfterAND)) {
                    System.out.println("*********************************************************************************************************************");
                    System.out.println("Тип ошибки №" + tok[0] + " - пакеты с несовпадающими данными после програмного \"И\"");
...
//********************************** ИСКЛЮЧИТЕЛЬНАЯ СИТУАЦИЯ ***********************************************************************************************
                     ...
                     * типу №3 (пакеты с несовпадающими данными после
                     * програмного "И"), а по факту ошибка относится к типу №5
